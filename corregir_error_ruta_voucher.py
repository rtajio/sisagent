#!/usr/bin/env python3
"""
Script para corregir el error de la ruta del voucher
"""
...
def corregir_error_ruta_voucher():
    """Corregir error de ruta del voucher"""
    
    print("🔧 CORRIGIENDO ERROR DE RUTA DEL VOUCHER")
    print("=" * 50)
    
    # 1. Crear app.py corregido
    print("📋 Paso 1: Creando app.py con ruta corregida...")
    app_corregido = '''#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""
...
'''
    ...
    print("✅ App.py con ruta corregida creado")
...
pytz==2023.3'''
  ...
  "deploy": {
    ...
    exito, salida, error = ejecutar_sin_pager('git commit -m "FIX: Corregir ruta voucher - sin caracteres especiales"')
    if exito:
        print("✅ Commit creado")
    ...
    print("\n" + "=" * 50)
    print("🎉 ERROR DE RUTA CORREGIDO")
    print("=" * 50)
    print("✅ Ruta /voucher/<int:operacion_id>/<tamanio> corregida")
    print("✅ Sin caracteres especiales (ñ)")
...
if __name__ == '__main__':
    print("🔄 Iniciando corrección de error de ruta...")
    print("📅 Fecha:", time.strftime('%d/%m/%Y %H:%M:%S'))
    print("-" * 50)
    
    if corregir_error_ruta_voucher():
        print("\n✅ Error de ruta corregido")
