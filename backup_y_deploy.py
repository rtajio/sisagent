...
# -*- coding: utf-8 -*-
"""
Script para crear backup previo con fecha de hoy y ejecutar deploy en Railway
"""
...
def crear_backup_hoy():
    """Crear backup completo del sistema con fecha de hoy"""
    
    print("=" * 80)
    print("🛡️ CREANDO BACKUP PREVIO DEL SISTEMA")
    print("=" * 80)
    ...
    print()
    print("📋 Creando archivo de información del backup...")
    ...
    backup_info = {
        ...
        "descripcion": "Backup previo antes de modificaciones del sistema - Código fuente, datos y configuraciones",
        "tipo": "Backup previo a modificaciones",
...
def main():
    ...
    print()
    print("=" * 80)
    print("🛡️ BACKUP Y DEPLOY AUTOMÁTICO - SISAGENT")
    print("=" * 80)
    ...
    try:
        ...
        backup_name, backup_path, zip_path = crear_backup_hoy()
