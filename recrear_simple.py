#!/usr/bin/env python3
"""
Script simple para recrear la base de datos sin conflictos
"""
...
def recrear_simple():
    """Recrear la base de datos de forma simple"""
    
    print("🚀 RECREACIÓN SIMPLE DE BASE DE DATOS")
    print("=" * 40)
