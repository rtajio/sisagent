...
VERSIÓN ULTRA OPTIMIZADA PARA MÁXIMO RENDIMIENTO
"""
...
print("🚀 SISAGENT Flask ULTRA OPTIMIZADO arrancando...")
...
class Sucursal(db.Model):
    ...
    hora_creacion = db.Column(db.DateTime, default=lambda: get_peru_time())
...
if __name__ == '__main__':
    init_db()
    print("🎉 SISAGENT Flask ULTRA OPTIMIZADO cargado completamente - Listo para producción!")
